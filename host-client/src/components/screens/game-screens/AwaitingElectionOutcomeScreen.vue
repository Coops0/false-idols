      ...
      <div class="text-center space-y-8">
        ...
        <div class="flex flex-col items-center gap-6">
          <div class="relative">
            ...
            <div class="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-br from-blue-500 to-blue-600 text-white px-6 py-2 rounded-xl text-lg font-medium shadow-sm border border-blue-400/50">
              {{ nominee.name }}
            </div>
          </div>
          <p class="text-xl text-gray-700 max-w-md">Should {{ nominee.name }} be elected as the new advisor?</p>
        </div>
      </div>
    </ModernCard>
  </div>
